...
public class BBoost extends Application {
    ...
    public void start(Stage primaryStage) {
     ...
     // PDF download button for Reports tab
        ...
        VBox reportsLayout = new VBox(10, downloadPdfButton);
    ...
    private void createAndSavePDF() throws IOException {
        try (PDDocument document = new PDDocument()) {
            ...
            contentStream.showText("Bannan Boost Report");
            contentStream.newLineAtOffset(0, -20);

            contentStream.showText("Affirmations:");
            contentStream.newLineAtOffset(0, -15);
            try (BufferedReader reader = new BufferedReader(new FileReader(AFFIRMATIONS_FILE))) {
                String line;
                while ((line = reader.readLine()) != null) {
                    if (line.length() > 100) line = line.substring(0, 100) + "..."; // Truncate long lines
            ...
            contentStream.showText("Check-Ins:");
            contentStream.newLineAtOffset(0, -15);
            ...
            contentStream.showText("Journals:");
            contentStream.newLineAtOffset(0, -15);
            ...
            document.save("BannanBoost_Report_" + timestamp + ".pdf");
        }
    }
